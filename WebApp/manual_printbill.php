...
$bill = 'C:/xampp/htdocs/Users/'.$email.'/manual_bills/bill.pdf';
$pdf_file = 'C:/xampp/htdocs/manual_bills/'.$dts.'.pdf';
...
if(file_exists($pdf_file)==TRUE){
    if(file_exists($bill)==TRUE){
        header('location: http://'.$ip.'/Users/'.$email.'/manual_bills/bill.pdf');
    }
}
else{
    echo "error";
