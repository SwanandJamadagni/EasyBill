...
/**
 * Created by Swanand on 05-03-2019.
 */
public class GetProducts extends AsyncTask<String, Void, String> {
    ...
    String[] products;
    GetProducts (Context ctx) { context = ctx; }
    @Override
    protected String doInBackground(String... params) {

        String ip = params[0];
        String type = params[1];
        String login_url = "http://"+ip+"/getproducts_manual_stock.php";


        if (type.equals("getproducts_manual_stock")) {
            try {
    ...
    protected void onPostExecute(String result) {
        if(result.equals("error")){
            ...
            Intent intent = new Intent(context, Manual_Bill.class);
