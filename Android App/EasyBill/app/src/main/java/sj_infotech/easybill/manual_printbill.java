...
public class manual_printbill extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manual_printbill);
...
//        Bitmap bitmap = BitmapFactory.decodeResource(mResources, R.drawable.screenshot);
        ...
        String directory_path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/EasyBill/ManualBills/";
        File file = new File(directory_path);
        if (!file.exists()) {
            file.mkdirs();
        }
        String targetPdf = directory_path+"manual_bill.pdf";
        File filePath = new File(targetPdf);
        try {
            document.writeTo(new FileOutputStream(filePath));
            Toast.makeText(this, "Done", Toast.LENGTH_LONG).show();
            viewPdf("manual_bill.pdf");
        } catch (IOException e) {
    ...
    private void viewPdf(String file) {
        ...
        File Dir = new File(Root.getAbsolutePath()+"/EasyBill/ManualBills");
